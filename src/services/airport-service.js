...
async function getAirport(id){
    try {
        ...
        if(error.statusCode === StatusCodes.NOT_FOUND){
            throw new AppError('Airport you Requestes not Found',error.statusCode)
        }
        throw new AppError('Cannot fetch data of airport by Id',StatusCodes.INTERNAL_SERVER_ERROR)
    }
}
